# PDF Annotate — native (Rust)

The same app as the browser version one folder up, rebuilt as a native Windows
program with [egui](https://github.com/emilk/egui) (glow/OpenGL backend) and
