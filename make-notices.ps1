...
[void]$out.AppendLine()
[void]$out.AppendLine('Kinetic PDF is licensed under MIT OR Apache-2.0. It includes the')
...
[void]$out.AppendLine()
[void]$out.AppendLine('Kinetic PDF uses pdfium under its BSD licence. Neither the name of')
